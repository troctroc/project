    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="/quanlythietbi/">Kiểm phiếu</a>
                ...
                <div class="nav-collapse collapse">
                    <?php $this->widget('zii.widgets.CMenu', array(
                        ...
                        'items' => array(
                            ...
                            array('label' => 'Danh sách tham dự', 'url' => '#'),
                            array('label' => 'Document', 'url' => array('#'), 'itemOptions' => array('class' => 'dropdown',),
                                'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => 'dropdown'),
                                'submenuOptions' => array('class' => 'dropdown-menu'),
                                'items' => array(
                                    array('label' => 'Phiếu xuât', 'url' => array('#')),
                                    array('label' => 'Phiếu nhập', 'url' => array('#')),
                                )
                            ),
                    ...
                    <?php if (app()->user->isGuest): ?>
                        ...
                        ?>
                        <form>
                            <?php echo $form->textField($model, 'username', array('max-length' => '10', 'class' => 'span2', 'placeholder' => 'username')); ?>
...
<?php endif; ?>
    ...
    <div class="container-fluid">
        ...
        <hr>
        <footer>
            <p>&copy; 2013 - Copyright and Developed by Troctroc  </p>
        </footer>
